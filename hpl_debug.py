...
简化命令行使用方式：
    python hpl_debug.py <hpl_file> [--verbose]
"""
...
def print_usage():
    print("HPL 调试工具")
    print("用法: python hpl_debug.py <hpl_file> [选项]")
    print("")
    print("选项:")
    ...
    print("")
    print("示例:")
    print("  python hpl_debug.py examples/debug_demo.hpl")
    print("  python hpl_debug.py examples/debug_demo.hpl --verbose")
